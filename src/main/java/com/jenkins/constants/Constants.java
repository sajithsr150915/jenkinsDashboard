...
public class Constants {
	...
	public static final String JENKINS_DETAILS_API_URL = "/api/json?tree=jobs[name,url,allBuilds[number,result,duration,url,timestamp,actions[buildsByBranchName[*[*[*]]]]]]";
	...
	public static final String JENKINS_TESTDETAILS_API_URL = "/api/json?tree=jobs[name,url,allBuilds[number,result,duration,url,actions[*]]]";
